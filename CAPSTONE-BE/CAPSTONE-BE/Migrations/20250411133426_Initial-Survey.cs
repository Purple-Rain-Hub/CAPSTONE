    ...
    public partial class InitialSurvey : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GameScores", x => new { x.SessionId, x.GameId });
                    table.ForeignKey(
                        name: "FK_GameScores_SurveySessions_SessionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SurveyAnswers", x => new { x.SessionId, x.Question });
                    table.ForeignKey(
                        name: "FK_SurveyAnswers_SurveySessions_SessionId",
                        column: x => x.SessionId,
                        principalTable: "SurveySessions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
